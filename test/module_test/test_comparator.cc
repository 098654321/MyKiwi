...
static void test_comparint_two_mode_controlbits() {
    // std::string file1{"..\\algorithm\\incremental_routing\\2025_10_30_test\\test_mode1_with_standard_file_of_mode2\\controlbits_comparison_in_cycles\\9\\5_controlbits_1.txt"};
