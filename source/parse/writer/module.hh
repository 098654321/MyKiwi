...
namespace kiwi::parse {
    ...
    auto output_two_modes_from_routing_results(
        hardware::Interposer* interposer, const std::FilePath& output_path, circuit::BaseDie* basedie, 
        std::Vector<std::shared_ptr<circuit::Net>> nets1, std::Vector<std::shared_ptr<circuit::Net>> nets2, 
        int mode1 = 1, int mode2 = 2
    ) -> void;
