...
namespace kiwi::circuit {
    ...
    auto BumpToTracksNet::route_multi_mode(hardware::Interposer* interposer, algo::OccupancyView& view, algo::HardwareRecorder& recorder, int mode) -> void {
        algo::route_bump_to_tracks_net_multi_mode(interposer, this, view, recorder, mode);
    }
    ...
    auto BumpToTracksNet::incremental_route(
        ...
        return strategy.route_bump_to_tracks_net(interposer, this, engine);
    }
