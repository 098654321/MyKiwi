...
namespace kiwi::circuit {
    ...
    auto TrackToBumpNet::route_multi_mode(hardware::Interposer* interposer, algo::OccupancyView& view, algo::HardwareRecorder& recorder, int mode) -> void {
        algo::route_track_to_bump_net_multi_mode(interposer, this, view, recorder, mode);
    }
    ...
    auto TrackToBumpNet::incremental_route(
        ...
        return strategy.route_track_to_bump_net(interposer, this, engine);
    }
    ...
    try {
        ...
        return *this->_end_bump == *cast_net._end_bump
            && *this->_begin_track == *cast_net._begin_track;
    }
    ...
    auto TrackToBumpNet::operator == (const TrackToBumpNet& net) const -> bool {
        return *this->_end_bump == *net._end_bump
            && *this->_begin_track == *net._begin_track;
    }
